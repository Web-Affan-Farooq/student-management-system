    ...
    return (
        <main className='flex h-auto bg-dark text-white p-[5px]'>
            <div>
                ...
                <form action="">
                    <div className='flex flex-col flex-nowrap gap-5 p-[20px] max-[500px]:p-[10px]'>
                        <label htmlFor="title of announcement" className='text-[15px] text-gray-400' id='announcement-title'>Announcement title</label>
                        <input type="text" name='announcementTitle' id='announcement-title' required className='px-[20px] py-[10px] bg-medium w-[300px] max-[400px]:w-[270px] rounded-md
            '/>
                    </div>
                    ...
                    <div className='flex flex-col flex-nowrap gap-5 p-[20px] max-[500px]:p-[10px]'>
                        ...
                        <textarea name='announcementDescription' id='announcement-description' required className='px-[20px] py-[10px] bg-medium md:w-[500px] md:h-[100px] sm:w-[500px] sm:h-[100px] max-sm:w-[80vw] max-sm:h-[100px] max-[400px]:w-[270px] rounded-md'></textarea>
                    </div>
                    <div className='flex flex-col flex-nowrap gap-5 p-[20px] max-[500px]:p-[10px]'>
                        ...
                        <div className='relative bg-medium rounded-md max-[400px]:w-[270px]'>
                            <input type="date" ref={datePickerRef} className='custom-date px-[20px] py-[10px] w-[300px] max-[400px]:w-[270px] rounded-md' />
