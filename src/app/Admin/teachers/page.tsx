    ...
    return (
        <div className="flex h-screen bg-dark text-white p-[5px]">
            ...
            <main className="flex-1 h-[100vh] grid grid-rows-[auto_1fr] gap-4 p-2 sm:p-4">
                ...
                <div className="scroll-container overflow-y-scroll bg-black h-screen p-6 rounded-lg ">

                    <div className="flex flex-row flex-wrap justify-between items-center">

                        <div className="font-bold flex flex-row flex-nowrap justify-start items-center">
                            <Image src="/icons/glass-icons/people.svg" alt="people" width={90} height={90} className="translate-y-[3px] max-md:w-[70px] max-sm:h-[70px]" /><span className="max-sm:text-[22px] sm:text-[22px] md:text-[25px]">Teachers</span>
                        </div>
                        <Searchbar />
